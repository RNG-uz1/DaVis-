<template>
    <el-row :gutter="2" style="width: 100%; height: 100%">
        <el-col :span="10">
            <div class="inputBox">
                <div class="printTitle">基础散点图</div>
                ...
                <div class="scroll">
                    <div class="input" v-for="item, index in arr">
                        {{ index + 1 }}.
                        x值：<el-input v-model="arr[index].x" style="margin-right: 10px"></el-input>
                        y值：<el-input v-model="arr[index].y"></el-input>
    ...
    methods: {
        drawPie() {
            ...
            for (let i = 0; i < this.arr.length; i++) {
                newitem.push([this.arr[i].x, this.arr[i].y])
            }
            // 绘制图表
            myChart.setOption({
                xAxis: {},
